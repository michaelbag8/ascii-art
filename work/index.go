// This file was were i learnt and practice all that i needed to implement
// align, color, output and reverse flag in my ascii art project
...
var banner = map[rune][]string{
    ...
    "| |  | | ",   // row 0 — 9 chars now
    "| |__| | ",   // row 1
    "|  __  | ",   // row 2 — wait, this doesn't look right
    "| |  | | ",   // row 3
    "|_|  |_| ",   // row 4
    "         ",   // row 5 — 9 spaces, already correct
    "         ",   // row 6
    "         ",   // row 7
},
	'i': {
...
func main() {
	...
	for position < len(lines[0]) {
		ch, width := findChar(lines, position, banner)
		if ch == 0 {
			break
		}
